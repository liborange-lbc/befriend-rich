...
export default function Backtest() {
  ...
  return (
    <div>
      ...
      <CopilotSection sectionName="回测配置" contextData={{ strategies: strategies.map((s) => s.name), funds: funds.map((f) => f.name) }}>
      ...
      {result && (<>
        <CopilotSection sectionName="回测指标" contextData={{ totalReturn: result.total_return, annualReturn: result.annual_return, sharpe: result.sharpe_ratio, maxDrawdown: result.max_drawdown, volatility: result.volatility, winRate: result.win_rate }}>
          <div className="section-card">
        ...
        <CopilotSection sectionName="净值曲线" contextData={{ dataPoints: equityCurve.length }}>
          <div className="section-card">
        ...
        <CopilotSection sectionName="交易明细" contextData={tradeLog}>
          <div className="section-card">
